package br.com.bacchiega.cambio_service.model;
...
public class Cambio implements Serializable {
    ...
    @Transient
    private BigDecimal convertedValue; // não vai ser salvo no banco pois é um valor calculado e devolvido para o outro serviço
    // seria mais interessante criar um DTO para retornar esse valor
