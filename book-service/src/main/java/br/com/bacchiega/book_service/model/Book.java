package br.com.bacchiega.book_service.model;
...
public class Book implements Serializable {
    ...
    private Double price; // na hora de salvar no banco vai ser em dólar, mas na hora de retornar o valor vai ser convertido para a moeda que o usuário pediu

    @Column(nullable = false, length = 200)
    private String title;

    @Transient
    private String currency; // transiente porque eu vou apenas passar o tipo da moeda que vai para o serviço de câmbio
